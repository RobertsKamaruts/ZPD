# -------------------------------------------------------------------------------------------------------------------------------------
#
# Šis fails satur izvēlēto pilskalnu un definēto teritoriju ģeogrāfiskās koordinātas. Vairākas programmas lietos šos datus.
#
# Veidoja: Roberts Kamarūts
#     
# -------------------------------------------------------------------
#
# This file contains the geographical coordinates for selected hillforts and defined territories. Multiple programs use this data.
#
# Created by: Roberts Kamarūts
#
# -------------------------------------------------------------------------------------------------------------------------------------
